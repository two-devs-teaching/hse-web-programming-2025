...
Каждая проверка оценивается в виде зачет (2б) / зачет с замечаниями (1б) / незачет (0б). 

Зачет ставится при заполнении всех  разделов рецензии, включающих:
...
Зачет с замечаниями ставится при частичном ответе, но не менее 50%.
